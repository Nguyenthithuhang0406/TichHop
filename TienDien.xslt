			...
			<body>
				...
				<table>
					...
					<tr>
						...
						<td>
							<xsl:choose>
								<xsl:when test="$sodien &gt; 100">100</xsl:when>
								<xsl:otherwise>
						...
						<td>
							<xsl:choose>
								<xsl:when test="$sodien &gt; 100">300000</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="$sodien * 3000"/>
								</xsl:otherwise>
							</xsl:choose>
					...
					<tr>
						...
						<td>
							<xsl:choose>
								<xsl:when test="$sodien &lt;= 100">0</xsl:when>
								<xsl:when test="$sodien &gt; 150">50</xsl:when>
								<xsl:otherwise>
						...
						<td>
							<xsl:choose>
								<xsl:when test="$sodien &lt;= 100">0</xsl:when>
								<xsl:when test="$sodien &gt; 150">200000</xsl:when>
								<xsl:otherwise>
					...
					<tr>
						...
						<td>
							<xsl:choose>
								<xsl:when test="$sodien &lt;= 150">0</xsl:when>
								<xsl:when test="$sodien &gt; 200">50</xsl:when>
								<xsl:otherwise>
						...
						<td>
							<xsl:choose>
								<xsl:when test="$sodien &lt;= 150">0</xsl:when>
								<xsl:when test="$sodien &gt; 200">225000</xsl:when>
								<xsl:otherwise>
					...
					<tr>
						...
						<td>
							<xsl:choose>
								<xsl:when test="$sodien &lt;= 200">0</xsl:when>
								<xsl:otherwise>
